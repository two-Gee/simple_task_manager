...
const initializeTables = () => {
  ...
  db.serialize(() => {
    ...
    db.run("CREATE TABLE tasks (id INTEGER PRIMARY KEY AUTOINCREMENT, title TEXT, dueDate TEXT, completed BOOLEAN, lockedBy INTEGER, lockExpiration INTEGER, listId INTEGER)");
    db.run("CREATE TABLE users (id INTEGER PRIMARY KEY AUTOINCREMENT, username TEXT)");
    db.run("CREATE TABLE taskAssignments (taskId INTEGER, userId INTEGER, addCounter INTEGER, removeCounter INTEGER, PRIMARY KEY (taskId, userId))");
...
const initializeTestData = () => {
    ...
    db.run("INSERT INTO tasks (title, dueDate, completed, lockedBy, lockExpiration, listId) VALUES ('Task 1', '2023-12-31', 0, NULL, NULL, 1)");
    db.run("INSERT INTO tasks (title, dueDate, completed, lockedBy, lockExpiration, listId) VALUES ('Task 2', '2023-12-31', 0, NULL, NULL, 1)");
    db.run("INSERT INTO tasks (title, dueDate, completed, lockedBy, lockExpiration, listId) VALUES ('Task 3', '2023-12-31', 0, NULL, NULL, 2)");
